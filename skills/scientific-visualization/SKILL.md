...
description: Design, create, and review clean, reproducible scientific data plots for manuscripts, presentations, and analysis. Use for Matplotlib or Seaborn figures, multi-panel layouts, concise labels and captions, stable figure filenames, uncertainty displays, simulation results, model validation, and computational benchmarks. Not for AI-generated illustrations or system architecture diagrams.
license: MIT
